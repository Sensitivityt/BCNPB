            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form id="form_research">
                        <div class="card shadow mb-4" id="card_form">
                            <div class="card-header py-3">
                                ...
                                <h6 class="card-title d-inline align-middle m-0 font-weight-bold text-primary">จัดการข้อมูลตำราหรือหนังสือ</h6>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group">
                                            <label for="research_journal_id">ประเภทตำราหรือหนังสือ </label>
                    ...
                    <div class="card shadow mb-4" id="card_tree">
                        <div class="card-header py-3">
                            <span class="badge badge-default float-right m-2"><button type="button" class="btn btn-success btn-sm" name="add" id="add"><i class="fa fa-plus"></i> เพิ่มตำราหรือหนังสือ</button></span>
                            <span class="badge badge-default float-right m-2"><button type="button" class="btn btn-info btn-sm" name="btn-sync" id="btn-sync"><i class="fa fa-sync"></i> Sync ข้อมูลตำราหรือหนังสือ</button></span>
                            <h6 class="card-title d-inline align-middle m-0 font-weight-bold text-primary">จัดการข้อมูลตำราหรือหนังสือ</h6>
                        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">ลบข้อมูลตำราหรือหนังสือ</h5>
